...
<body class="bg-gray-50 flex items-center justify-center min-h-screen">
    ...
    <div class="bg-white p-8 rounded-xl shadow-lg w-full max-w-md border border-gray-100">
        ...
        <?php if($error): ?>
            <div class="bg-red-50 text-red-600 p-3 rounded-lg mb-4 text-sm text-center font-medium"><?php echo $error; ?></div>
        <?php endif; ?>
        ...
        <form method="POST" class="space-y-4">
            <div>
                ...
                <input type="text" name="username" required class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none transition-all">
            </div>
            <div>
            ...
            <button type="submit" class="w-full bg-blue-600 hover:bg-blue-700 text-white font-semibold py-2.5 rounded-lg transition-colors shadow-sm mt-2">
                Sign Up
            </button>
        </form>
