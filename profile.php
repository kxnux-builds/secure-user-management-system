        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between h-16 items-center">
                <div class="flex items-center space-x-4">
                    <a href="dashboard.php" class="text-gray-500 hover:text-gray-700 flex items-center transition-colors">
            ...
            <div class="p-8">
                ...
                <div class="flex flex-col md:flex-row gap-8 items-start">
                    ...
                    <div class="flex flex-col items-center space-y-4">
                        <div class="relative w-32 h-32 rounded-full overflow-hidden border-4 border-white shadow-lg bg-gray-100 flex-shrink-0">
                            <img src="<?php echo $profile_img; ?>" alt="Profile Picture" class="w-full h-full object-cover">
                        </div>
                        <div class="text-center">
                            <h3 class="font-bold text-gray-900 text-lg"><?php echo htmlspecialchars($user_data['username']); ?></h3>
                            <p class="text-gray-500 text-sm"><?php echo htmlspecialchars($user_data['email']); ?></p>
                        </div>
                    </div>

                    <div class="flex-1 w-full mt-6 md:mt-0">
                        <form method="POST" enctype="multipart/form-data" class="bg-gray-50 p-6 rounded-lg border border-gray-200">
                            ...
                            <div class="flex items-center justify-center w-full mb-4">
                                <label for="dropzone-file" class="flex flex-col items-center justify-center w-full h-32 border-2 border-gray-300 border-dashed rounded-lg cursor-pointer bg-white hover:bg-gray-50 transition-colors">
                                    ...
                                    <input id="dropzone-file" type="file" name="profile_pic" class="hidden" accept="image/png, image/jpeg, image/gif" required />
                                </label>
                            </div>
